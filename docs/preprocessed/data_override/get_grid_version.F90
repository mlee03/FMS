# 1 "data_override/get_grid_version.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "data_override/get_grid_version.F90"
!***********************************************************************
...
# 1 "data_override/include/get_grid_version_r4.fh" 1
!***********************************************************************
!*                             Apache License 2.0
!*
!* This file is part of the GFDL Flexible Modeling System (FMS).
...
# 1 "data_override/include/get_grid_version.inc" 1
!***********************************************************************
!*                             Apache License 2.0
!*
!* This file is part of the GFDL Flexible Modeling System (FMS).
...
subroutine get_grid_version_1_r4(grid_file, mod_name, domain, lon, lat, min_lon, max_lon)
...
end subroutine get_grid_version_1_r4
...
subroutine get_grid_version_2_r4(fileobj, mod_name, domain, lon, lat, min_lon, max_lon, use_center_grid_points)
  integer, parameter :: lkind = r4_kind
...
end subroutine get_grid_version_2_r4
# 29 "data_override/include/get_grid_version_r4.fh" 2

# 72 "data_override/get_grid_version.F90" 2

# 1 "data_override/include/get_grid_version_r8.fh" 1
!***********************************************************************
!*                             Apache License 2.0
!*
!* This file is part of the GFDL Flexible Modeling System (FMS).
...
!> Get global lon and lat of three model (target) grids, with a given file name
subroutine get_grid_version_1_r8(grid_file, mod_name, domain, lon, lat, min_lon, max_lon)
...
!2 Global lon and lat of ocean grid cell centers are determined from adjacent vertices
  ...
  call mpp_min(min_lon)
  call mpp_max(max_lon)
end subroutine get_grid_version_1_r8

!> Get global lon and lat of three model (target) grids from mosaic.nc.
!! Currently we assume the refinement ratio is 2 and there is one tile on each pe.
subroutine get_grid_version_2_r8(fileobj, mod_name, domain, lon, lat, min_lon, max_lon, use_center_grid_points)
  integer, parameter :: lkind = r8_kind
  ...
  call close_file(tilefileobj)
  if(open_solo_mosaic)  call close_file(mosaicfileobj)
end subroutine get_grid_version_2_r8
# 29 "data_override/include/get_grid_version_r8.fh" 2

# 73 "data_override/get_grid_version.F90" 2
