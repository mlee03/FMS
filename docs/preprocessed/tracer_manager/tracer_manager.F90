# 1 "tracer_manager/tracer_manager.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "tracer_manager/tracer_manager.F90"
!***********************************************************************
...
# 174 "tracer_manager/tracer_manager.F90" 2
...
# 1 "tracer_manager/include/tracer_manager_r4.fh" 1
!***********************************************************************
!*                             Apache License 2.0
!*
!* This file is part of the GFDL Flexible Modeling System (FMS).
...
# 1 "tracer_manager/include/tracer_manager.inc" 1
!***********************************************************************
!*                             Apache License 2.0
!*
!* This file is part of the GFDL Flexible Modeling System (FMS).
...
integer, intent(in) :: model !< Parameter representing component model in use
integer, intent(in) :: n !< Tracer number
real(r4_kind), intent(inout), dimension(:,:,:) :: tracer !< Initialized tracer array
character(len=*), intent(out), optional :: err_msg

real(r4_kind)  :: surf_value, multiplier
integer :: numlevels, k, n1, flag
real(r4_kind) :: top_value, bottom_value
...
!#######################################################################
# 26 "tracer_manager/include/tracer_manager_r4.fh" 2
# 1216 "tracer_manager/tracer_manager.F90" 2

# 1 "tracer_manager/include/tracer_manager_r8.fh" 1
!***********************************************************************
!*                             Apache License 2.0
!*
!* This file is part of the GFDL Flexible Modeling System (FMS).
...
integer, intent(in) :: model !< Parameter representing component model in use
integer, intent(in) :: n !< Tracer number
real(r8_kind), intent(inout), dimension(:,:,:) :: tracer !< Initialized tracer array
character(len=*), intent(out), optional :: err_msg

real(r8_kind)  :: surf_value, multiplier
integer :: numlevels, k, n1, flag
real(r8_kind) :: top_value, bottom_value
character(len=80)  :: scheme, control,profile_type
character(len=128) :: err_msg_local
character(len=11)  :: chn
...
!#######################################################################
# 26 "tracer_manager/include/tracer_manager_r8.fh" 2
# 1217 "tracer_manager/tracer_manager.F90" 2
