# 1 "string_utils/fms_string_utils.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "string_utils/fms_string_utils.F90"
!***********************************************************************
...
# 1 "string_utils/include/fms_string_utils_r4.fh" 1
!***********************************************************************
!*                             Apache License 2.0
!*
!* This file is part of the GFDL Flexible Modeling System (FMS).
...
# 1 "string_utils/include/fms_string_utils.inc" 1
!***********************************************************************
!*                             Apache License 2.0
!*
!* This file is part of the GFDL Flexible Modeling System (FMS).
...
function stringify_1d_r4(arr, fmt)
  real(r4_kind), dimension(:), intent(in) :: arr !< Real array to be converted to a string
  character(*), intent(in), optional :: fmt !< Optional format string for the real array entries
  character(:), allocatable :: stringify_1d_r4
  integer :: i, n

  n = size(arr)

  if (n .gt. 0) then
    stringify_1d_r4 = "[" // string(arr(1), fmt)
  else
    stringify_1d_r4 = "["
  endif

  do i = 2,n
    stringify_1d_r4 = stringify_1d_r4 // ", " // string(arr(i), fmt)
  enddo

  stringify_1d_r4 = stringify_1d_r4 // "]"
end function

!> @brief Converts a 2D array of real numbers to a string
!> @return The 2D array as a string
function stringify_2d_r4(arr, fmt)
  real(r4_kind), dimension(:,:), intent(in) :: arr !< Real array to be converted to a string
  character(*), intent(in), optional :: fmt !< Optional format string for the real array entries
  character(:), allocatable :: stringify_2d_r4
  integer :: i, n

  n = size(arr, 2)

  if (n .gt. 0) then
    stringify_2d_r4 = "[" // stringify_1d_r4(arr(:,1), fmt)
  else
    stringify_2d_r4 = "["
  endif

  do i = 2,n
    stringify_2d_r4 = stringify_2d_r4 // ", " // stringify_1d_r4(arr(:,i), fmt)
  enddo

  stringify_2d_r4 = stringify_2d_r4 // "]"
end function

!> @brief Converts a 3D array of real numbers to a string
!> @return The 3D array as a string
function stringify_3d_r4(arr, fmt)
  real(r4_kind), dimension(:,:,:), intent(in) :: arr !< Real array to be converted to a string
  character(*), intent(in), optional :: fmt !< Optional format string for the real array entries
  character(:), allocatable :: stringify_3d_r4
  integer :: i, n

  n = size(arr, 3)

  if (n .gt. 0) then
    stringify_3d_r4 = "[" // stringify_2d_r4(arr(:,:,1), fmt)
  else
    stringify_3d_r4 = "["
  endif

  do i = 2,n
    stringify_3d_r4 = stringify_3d_r4 // ", " // stringify_2d_r4(arr(:,:,i), fmt)
  enddo

  stringify_3d_r4 = stringify_3d_r4 // "]"
end function
# 25 "string_utils/include/fms_string_utils_r4.fh" 2

# 320 "string_utils/fms_string_utils.F90" 2

# 1 "string_utils/include/fms_string_utils_r8.fh" 1
!***********************************************************************
!*                             Apache License 2.0
!*
!* This file is part of the GFDL Flexible Modeling System (FMS).
...
!> @brief Converts a 1D array of real numbers to a string
!> @return The 1D array as a string
function stringify_1d_r8(arr, fmt)
  real(r8_kind), dimension(:), intent(in) :: arr !< Real array to be converted to a string
  character(*), intent(in), optional :: fmt !< Optional format string for the real array entries
  character(:), allocatable :: stringify_1d_r8
  integer :: i, n

  n = size(arr)

  if (n .gt. 0) then
    stringify_1d_r8 = "[" // string(arr(1), fmt)
  else
    stringify_1d_r8 = "["
  endif

  do i = 2,n
    stringify_1d_r8 = stringify_1d_r8 // ", " // string(arr(i), fmt)
  enddo

  stringify_1d_r8 = stringify_1d_r8 // "]"
end function

!> @brief Converts a 2D array of real numbers to a string
!> @return The 2D array as a string
function stringify_2d_r8(arr, fmt)
  real(r8_kind), dimension(:,:), intent(in) :: arr !< Real array to be converted to a string
  character(*), intent(in), optional :: fmt !< Optional format string for the real array entries
  character(:), allocatable :: stringify_2d_r8
  integer :: i, n

  n = size(arr, 2)

  if (n .gt. 0) then
    stringify_2d_r8 = "[" // stringify_1d_r8(arr(:,1), fmt)
  else
    stringify_2d_r8 = "["
  endif

  do i = 2,n
    stringify_2d_r8 = stringify_2d_r8 // ", " // stringify_1d_r8(arr(:,i), fmt)
  enddo

  stringify_2d_r8 = stringify_2d_r8 // "]"
end function

!> @brief Converts a 3D array of real numbers to a string
!> @return The 3D array as a string
function stringify_3d_r8(arr, fmt)
  real(r8_kind), dimension(:,:,:), intent(in) :: arr !< Real array to be converted to a string
  character(*), intent(in), optional :: fmt !< Optional format string for the real array entries
  character(:), allocatable :: stringify_3d_r8
  integer :: i, n

  n = size(arr, 3)

  if (n .gt. 0) then
    stringify_3d_r8 = "[" // stringify_2d_r8(arr(:,:,1), fmt)
  else
    stringify_3d_r8 = "["
  endif

  do i = 2,n
    stringify_3d_r8 = stringify_3d_r8 // ", " // stringify_2d_r8(arr(:,:,i), fmt)
  enddo

  stringify_3d_r8 = stringify_3d_r8 // "]"
end function
# 25 "string_utils/include/fms_string_utils_r8.fh" 2

# 321 "string_utils/fms_string_utils.F90" 2
