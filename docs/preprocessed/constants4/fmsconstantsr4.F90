# 1 "constants4/fmsconstantsr4.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "constants4/fmsconstantsr4.F90"
!***********************************************************************
...
# 1 "constants4/gfdl_constantsR4.fh" 1
!***********************************************************************
!*                             Apache License 2.0
!*
!* This file is part of the GFDL Flexible Modeling System (FMS).
...
real(kind=r8_kind), public, parameter :: PI_8 = 3.14159265358979323846_r8_kind  !< Ratio of circle circumference
                                                                                !! to diameter [N/A]
real(kind=r4_kind),   public, parameter :: PI   = PI_8                            !< Ratio of circle circumferen
                                                                                !! to diameter [N/A]
...
real(kind=r4_kind),   public, parameter :: RADIAN      = RAD_TO_DEG               !< Equal to RAD_TO_DEG for backward
...
real(kind=r4_kind), public, parameter :: RVGAS    = 461.50_r8_kind            !< Gas constant for water vapor
                                                                            !! [J/kg/deg]
...
real(kind=r4_kind), public, parameter :: CP_VAPOR = 4.0_r8_kind*RVGAS         !< Specific heat capacity of water vapor
                                                                            !! at constant pressure [J/kg/deg]
real(kind=r4_kind), public, parameter :: CP_OCEAN = 3989.24495292815_r8_kind  !< Specific heat capacity taken
                                                                            !! from McDougall (2002)
...
real(kind=r4_kind), public, parameter :: RHO0R    = 1.0_r8_kind/RHO0          !< Reciprocal of average density of
                                                                            !! sea water [m^3/kg]
real(kind=r4_kind), public, parameter :: RHO_CP   = RHO0*CP_OCEAN             !< (kg/m^3)*(cal/kg/deg C)(joules/cal) =
                                                                            !! (joules/m^3/deg C) [J/m^3/deg]
real(kind=r4_kind), public, parameter :: O2MIXRAT = 2.0953E-01_r8_kind        !< Mixing ratio of molecular oxygen
...
real(kind=r4_kind), public, parameter :: WTMCO2   =  44.00995_r8_kind         !< Molecular weight of carbon dioxide
                                                                            !! [AMU]
real(kind=r4_kind), public, parameter :: WTMCH4   =  16.0425_r8_kind          !< Molecular weight of methane [AMU]
real(kind=r4_kind), public, parameter :: WTMO2    =  31.9988_r8_kind          !< Molecular weight of molecular oxygen
                                                                            !! [AMU]
real(kind=r4_kind), public, parameter :: WTMCFC11 = 137.3681_r8_kind          !< Molecular weight of CFC-11
                                                                            !! (CCl3F) [AMU]
real(kind=r4_kind), public, parameter :: WTMCFC12 = 120.9135_r8_kind          !< Molecular weight of CFC-21
                                                                            !! (CCl2F2) [AMU]
...
real(kind=r4_kind), public, parameter :: ALOGMIN    = -50.0_r8_kind        !< Minimum value allowed as argument
                                                                         !! to log function [N/A]
real(kind=r4_kind), public, parameter :: EPSLN      = 1.0E-40_r8_kind      !< A small number to prevent divide by zero
                                                                         !! exceptions [N/A]
real(kind=r4_kind), public, parameter :: RADCON     = ((1.0E+02*GRAV)/(1.0D+04*CP_AIR))*SECONDS_PER_DAY !< Factor to
                                                                        !! convert flux divergence
                                                                        !! to heating rate in degrees per day
                                                                        !! [deg sec/(cm day)]
real(kind=r4_kind), public, parameter :: RADCON_MKS = (GRAV/CP_AIR)*SECONDS_PER_DAY !< Factor to
                                                                        !! convert flux divergence
                                                                        !! to heating rate in degrees per day
                                                                        !! [deg sec/(m day)]
# 70 "constants4/fmsconstantsr4.F90" 2
# 79 "constants4/fmsconstantsr4.F90"
