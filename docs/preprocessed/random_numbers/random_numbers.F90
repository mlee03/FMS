# 1 "random_numbers/random_numbers.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "random_numbers/random_numbers.F90"
!***********************************************************************
...
# 1 "random_numbers/include/random_numbers_r4.fh" 1
!***********************************************************************
!*                             Apache License 2.0
!*
!* This file is part of the GFDL Flexible Modeling System (FMS).
...
# 1 "random_numbers/include/random_numbers.inc" 1
!***********************************************************************
!*                             Apache License 2.0
!*
!* This file is part of the GFDL Flexible Modeling System (FMS).
...
!***********************************************************************
  ...
  !> Draws random scalar
  subroutine get_random_number_0d_r4(stream, number)
    type(randomNumberStream), intent(inout) :: stream
    real(r4_kind),       intent(  out) :: number

    number = real(getRandomReal(stream%theNumbers), r4_kind)
  end subroutine

  !> Draws random 1D array
  subroutine get_random_number_1d_r4(stream, numbers)
    type(randomNumberStream),         intent(inout) :: stream
    real(r4_kind), dimension(:), intent(  out) :: numbers

    ! Local variables
    integer :: i

    do i = 1, size(numbers)
      call get_random_number_0d_r4(stream, numbers(i))
    end do
  end subroutine

  !> Draws random 2D array
  subroutine get_random_number_2d_r4(stream, numbers)
    type(randomNumberStream),            intent(inout) :: stream
    real(r4_kind), dimension(:, :), intent(  out) :: numbers
    ...
    do i = 1, size(numbers, 2)
      call get_random_number_1d_r4(stream, numbers(:, i))
    end do
  end subroutine
# 30 "random_numbers/include/random_numbers_r4.fh" 2

# 104 "random_numbers/random_numbers.F90" 2

# 1 "random_numbers/include/random_numbers_r8.fh" 1
!***********************************************************************
!*                             Apache License 2.0
!*
!* This file is part of the GFDL Flexible Modeling System (FMS).
...
!***********************************************************************
  ...
  !> Draws random scalar
  subroutine get_random_number_0d_r8(stream, number)
    type(randomNumberStream), intent(inout) :: stream
    real(r8_kind),       intent(  out) :: number

    number = real(getRandomReal(stream%theNumbers), r8_kind)
  end subroutine

  !> Draws random 1D array
  subroutine get_random_number_1d_r8(stream, numbers)
    type(randomNumberStream),         intent(inout) :: stream
    real(r8_kind), dimension(:), intent(  out) :: numbers

    ! Local variables
    integer :: i

    do i = 1, size(numbers)
      call get_random_number_0d_r8(stream, numbers(i))
    end do
  end subroutine

  !> Draws random 2D array
  subroutine get_random_number_2d_r8(stream, numbers)
    type(randomNumberStream),            intent(inout) :: stream
    real(r8_kind), dimension(:, :), intent(  out) :: numbers
    ...
    do i = 1, size(numbers, 2)
      call get_random_number_1d_r8(stream, numbers(:, i))
    end do
  end subroutine
# 30 "random_numbers/include/random_numbers_r8.fh" 2

# 105 "random_numbers/random_numbers.F90" 2
