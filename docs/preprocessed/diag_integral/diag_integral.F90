# 1 "diag_integral/diag_integral.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "diag_integral/diag_integral.F90"
!***********************************************************************
...
# 59 "diag_integral/diag_integral.F90" 2
...
# 1 "diag_integral/include/diag_integral_r4.fh" 1
!***********************************************************************
!*                             Apache License 2.0
!*
!* This file is part of the GFDL Flexible Modeling System (FMS).
...
# 1 "diag_integral/include/diag_integral.inc" 1
!***********************************************************************
!*                             Apache License 2.0
!*
!* This file is part of the GFDL Flexible Modeling System (FMS).
...
!!
subroutine sum_field_2d_r4 (name, field_data2d, is, js)

character(len=*),  intent(in) :: name !< Name of the field to be integrated
real(r4_kind), intent(in) :: field_data2d(:,:) !< field of integrands to be summed over
...
end subroutine sum_field_2d_r4
...
!! @param [in] <is, js> starting i,j indices over which summation is to occur
!!
subroutine sum_field_3d_r4 (name, field_data3d, is, js)

character(len=*),  intent(in) :: name !< Name of the field to be integrated
real(r4_kind),  intent(in) :: field_data3d(:,:,:) !< field of integrands to be summed over
...
end subroutine sum_field_3d_r4
...
!! @param [in] <is, js> starting i,j indices over which summation is to occur
!!
subroutine sum_field_wght_3d_r4 (name, field_data3d, wt, is, js)

character(len=*),   intent(in) :: name !< Name of the field to be integrated
real(r4_kind), intent(in) :: field_data3d(:,:,:) !< field of integrands to be summed over
real(r4_kind), intent(in) :: wt(:,:,:) !< the weight function to be evaluated at summation
integer, optional,  intent(in) :: is !< starting i indices over which summation is to occur
integer, optional,  intent(in) :: js !< starting j indices over which summation is to occur
...
end subroutine sum_field_wght_3d_r4
...
!!        is to occur
!!
subroutine sum_field_2d_hemi_r4 (name, field_data2d, is, ie, js, je)
...
end subroutine sum_field_2d_hemi_r4
# 36 "diag_integral/include/diag_integral_r4.fh" 2
# 1121 "diag_integral/diag_integral.F90" 2

# 1 "diag_integral/include/diag_integral_r8.fh" 1
!***********************************************************************
!*                             Apache License 2.0
!*
!* This file is part of the GFDL Flexible Modeling System (FMS).
...
!! @param [in] <is, js> starting i,j indices over which summation is to occur
!!
subroutine sum_field_2d_r8 (name, field_data2d, is, js)

character(len=*),  intent(in) :: name !< Name of the field to be integrated
real(r8_kind), intent(in) :: field_data2d(:,:) !< field of integrands to be summed over
integer, optional, intent(in) :: is !< starting i indices over which summation is to occur
integer, optional, intent(in) :: js !< starting j indices over which summation is to occur
...
end subroutine sum_field_2d_r8
...
!! @param [in] <is, js> starting i,j indices over which summation is to occur
!!
subroutine sum_field_3d_r8 (name, field_data3d, is, js)

character(len=*),  intent(in) :: name !< Name of the field to be integrated
real(r8_kind),  intent(in) :: field_data3d(:,:,:) !< field of integrands to be summed over
integer, optional, intent(in) :: is !< starting i,j indices over which summation is to occur
integer, optional, intent(in) :: js !< starting i,j indices over which summation is to occur
...
end subroutine sum_field_3d_r8
...
!! @param [in] <is, js> starting i,j indices over which summation is to occur
!!
subroutine sum_field_wght_3d_r8 (name, field_data3d, wt, is, js)

character(len=*),   intent(in) :: name !< Name of the field to be integrated
real(r8_kind), intent(in) :: field_data3d(:,:,:) !< field of integrands to be summed over
real(r8_kind), intent(in) :: wt(:,:,:) !< the weight function to be evaluated at summation
integer, optional,  intent(in) :: is !< starting i indices over which summation is to occur
integer, optional,  intent(in) :: js !< starting j indices over which summation is to occur
...
end subroutine sum_field_wght_3d_r8
...
!!        is to occur
!!
subroutine sum_field_2d_hemi_r8 (name, field_data2d, is, ie, js, je)
...
end subroutine sum_field_2d_hemi_r8
# 35 "diag_integral/include/diag_integral_r8.fh" 2
# 1122 "diag_integral/diag_integral.F90" 2
